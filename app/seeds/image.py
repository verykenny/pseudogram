...
def seed_images():
    ...
    img34 = Image(userId=17, imgUrl='https://images.unsplash.com/photo-1504805572947-34fad45aed93?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2000&q=80',
                  caption='I have a lot to do this week...', totalLikes=2, createdAt=f'{now}')
    img35 = Image(userId=24, imgUrl='https://images.unsplash.com/photo-1611424564056-65b8f1403ba2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80',
                  caption='awwww, alice...', totalLikes=1, createdAt=f'{now}')
    img36 = Image(userId=23, imgUrl='https://images.unsplash.com/photo-1631749860812-9cb1bf3d312c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80',
                  caption='Found this in my backyard last night', totalLikes=2, createdAt=f'{now}')
    img37 = Image(userId=17, imgUrl='https://images.unsplash.com/photo-1629090970758-05e6903db132?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=701&q=80',
                  caption='What a place...', totalLikes=3, createdAt=f'{now}')
